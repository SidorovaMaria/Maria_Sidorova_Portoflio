  ...
  return (
    <>
      <form
        ...
        className="rounded-2xl p-4 bg-gradient-to-b from-bg/30 to-primary/30 backdrop-blur-md h-full flex flex-col justify-between gap-2 origin-bottom-left contact-form"
      >
      ...
      <div
        className="p-6 bg-gradient-to-br from-bg to-green-300 dark:to-green-900 border border-green-300 dark:border-green-900  rounded-xl shadow-lg scale-y-0 origin-top hidden"
        ref={successMessageRef}
      >
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 flex items-center justify-center bg-green-800 rounded-full flex-shrink-0 mt-1">
      ...
      <div
        className="p-6 bg-gradient-to-br from-bg to-red-300 dark:to-red-900 border border-red-300 dark:border-red-900 rounded-xl shadow-lg origin-top scale-y-0 hidden
        "
        ref={errorMessageRef}
      >
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 flex items-center justify-center bg-red-800 rounded-full flex-shrink-0 mt-1">
