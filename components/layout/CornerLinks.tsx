...
type ConnectSectionProps = {
  connectLinks: { label: string; href: string; icon?: React.ElementType }[];
};

const CornerLinks = ({ connectLinks }: ConnectSectionProps) => {
  ...
  return (
    <div className="relative " ref={menuContainer}>
      <div
        role="navigation"
        className="flex flex-col md:flex-row justify-center gap-8 mt-8 w-fit mx-auto"
      >
